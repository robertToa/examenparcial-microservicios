...
import com.util.svcinventory.exception.BusinessRuleException;
import com.util.svcinventory.exception.DuplicateResourceException;
import com.util.svcinventory.exception.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleResourceFounException(
        ...
        log.warn("Recurso no encontrado: {} - Path: {}", ex.getMessage(), httpServletRequest.getRequestURI());
